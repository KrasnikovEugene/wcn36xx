...
struct add_ts_req_msg {
	...
	/* Service Interval */
	u32 srvInterval[WLAN_HAL_MAX_AC];

	/* Suspend Interval */
	u32 susInterval[WLAN_HAL_MAX_AC];
...
struct hal_nv_img_download_req_msg {
	 ...
	 * a WLAN_HAL_DOWNLOAD_NV_RSP to the WLAN_HAL_DOWNLOAD_NV_REQ after
...
struct hal_nv_img_download_rsp_msg {
	 ...
	 * WLAN_HAL_DOWNLOAD_NV_RSP after each fragment */
	u32 status;
};
